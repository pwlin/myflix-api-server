...
routes.comics = require('./routes/animations');
...
function serve(db, config) {
    ...
    app.use('/animations/genre/:genre', function (req, res) {
        routes.comics.genre(req, res, db, cache);
    });

    app.use('/animations/genres', function (req, res) {
        routes.comics.genres(req, res, db, cache);
    });

    app.use('/animations/search/:q', function (req, res) {
        routes.comics.search(req, res, db, cache);
    });

    app.use('/animations/movie/:id', function (req, res) {
        routes.comics.movie(req, res, db, cache);
    });

    app.use('/animations', function (req, res) {
